...
import { listRepoFiles, listSourceFiles } from './list-source-files.js';
import {
...
it('includes YAML files in the default source extension sweep', () => {
  expect(SUPPORTED_SOURCE_FILE_EXTENSIONS).toContain('.yaml');
  expect(SUPPORTED_SOURCE_FILE_EXTENSIONS).toContain('.yml');
