...
it('renders show output with a compact incoming summary and an empty incoming state', () => {
  ...
  expect(renderPlainOutput(empty_incoming_output_view)).toBe(
    '# Guide\n' +
      '\n' +
      '----------------\n' +
      'incoming refs:\n' +
      '  none\n' +
      '\n' +
      'Hint: patram refs docs/guide.md\n',
  );
});
