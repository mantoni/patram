      ...
      fields: [
        {
          ...
          select: [
            ...
            {
              value: 'blocked',
              when: 'any(in:tracked_in, kind=task and status not in [done, dropped, superseded]) and none(in:tracked_in, kind=task and status not in [done, dropped, superseded] and not status=blocked)',
            },
            {
              value: 'in_progress',
              when: 'any(in:tracked_in, kind=task and not status=pending)',
            },
          ],
        },
        {
