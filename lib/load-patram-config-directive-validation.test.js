...
function createExpectedFieldSchemaDiagnostics() {
  return [
    ...
    createDiagnostic(
      'Invalid config at "class_schemas.missing_task": Unknown class "missing_task".',
    ),
    createDiagnostic(
      'Invalid config at "class_schemas.task.fields.missing_field": Unknown field "missing_field".',
    ),
    createDiagnostic(
      'Invalid config at "class_schemas.missing_task.document_path_class": Unknown path class "task_docs".',
    ),
  ];
}
