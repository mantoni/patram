    ...
    classes: {
      ...
      missing_task: {
        schema: {
          ...
          markdown_styles: ['front_matter', 'side_note'],
          mixed_styles: 'warn',
        },
      },
      task: {
...
function createExpectedFieldSchemaDiagnostics() {
  return [
    ...
    createDiagnostic(
      'Invalid config at "classes.missing_task.schema.markdown_styles": Unknown markdown style "side_note".',
    ),
    createDiagnostic(
      'Invalid config at "classes.missing_task.schema.mixed_styles": Mixed styles must be "ignore" or "error".',
    ),
    createDiagnostic(
      'Invalid config at "classes.missing_task.schema.fields.tracked_in.markdown_styles": Markdown styles must contain at least one style.',
    ),
    createDiagnostic(
