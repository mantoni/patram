 ...
 * @param {{ cypher?: string, description?: string, where?: string }} stored_query_mutation
 * @returns {StoredQueryConfig}
 */
...
function createBaseStoredQueryDefinition(raw_query_value, existing_query) {
  ...
  } else if (existing_query.where !== undefined) {
    next_query.where = existing_query.where;
  }
