 ...
 * @param {{ document_node_ids?: BuildGraphResult['document_node_ids'], graph_nodes?: BuildGraphResult['nodes'], repo_config?: PatramRepoConfig }=} command_options
...
function createOutputNodeItem(graph_node, field_definitions) {
  const description = getScalarGraphNodeField(graph_node.description);
  ...
  return Object.entries(fields)
    .filter(
      ([field_name]) =>
        ...
        field_definitions[field_name]?.display?.hidden !== true,
    )
