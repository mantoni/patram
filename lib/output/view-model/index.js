 ...
 *
 * @param {{ incoming_summary: Record<string, number>, path: string, rendered_source: string, resolved_links: Array<{ label: string, reference: number, source?: { claim_type: 'directive', column: number, line: number, markdown_style?: import('../../parse/parse-claims.types.ts').MarkdownDirectiveStyle, parser?: string, raw_target: string }, target: { kind?: string, path: string, status?: string, title: string } }>, source: string }} show_output
...
/**
 * @param {{ label: string, reference: number, source?: { claim_type: 'directive', column: number, line: number, markdown_style?: import('../../parse/parse-claims.types.ts').MarkdownDirectiveStyle, parser?: string, raw_target: string }, target: { kind?: string, path: string, status?: string, title: string } }} resolved_link
 * @param {{ document_path_ids?: BuildGraphResult['document_path_ids'], graph_nodes?: BuildGraphResult['nodes'], repo_config?: PatramRepoConfig }} command_options
...
function createResolvedLinkOutputItem(resolved_link, command_options) {
  ...
  if (resolved_link.source) {
    output_item.source = resolved_link.source;
  }
