...
it('keeps inline show annotation text stable in tty output', () => {
  const output_view = createShowOutputView(
    {
      incoming_summary: {},
      path: 'docs/patram.md',
      rendered_source:
        '# Patram\n\nSee [Plan](./plans/v0/output-contract-alignment.md)[^1].\n\n[^1] plan docs/plans/v0/output-contract-alignment.md  (status=active)\n    Output Contract Alignment Plan',
      resolved_links: [
        {
          label: 'Plan',
          reference: 1,
...
it('renders show json output with directive resolved links', () => {
  const output_view = createShowOutputView(
    {
      incoming_summary: {},
    ...
    {
      document_path_ids: {
        'docs/decisions/check-command.md': 'decision:check-command',
        'docs/roadmap/v0-dogfood.md': 'roadmap:v0-dogfood',
      },
      graph_nodes: {
        'decision:check-command': {
          $class: 'decision',
          $id: 'decision:check-command',
          $path: 'docs/decisions/check-command.md',
          id: 'decision:check-command',
          path: 'docs/decisions/check-command.md',
          status: 'accepted',
          title: 'Check Command Proposal',
        },
        'roadmap:v0-dogfood': {
          $class: 'roadmap',
          $id: 'roadmap:v0-dogfood',
          $path: 'docs/roadmap/v0-dogfood.md',
          id: 'roadmap:v0-dogfood',
          path: 'docs/roadmap/v0-dogfood.md',
          status: 'active',
